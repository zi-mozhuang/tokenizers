...
//!
//! Faithful port of the NEON path (`simd_classify.rs`): same tables (`ATOM_TABLES`), same algorithm
...
//!
//! UNTESTED at runtime on aarch64 hosts (cross-compiles only). Validate `== classify_scalar` on
